...
class NMEASentence(NMEASentenceBase):
    ...
    def parse(line, check=False):
        ...
        # error check that third field is populated with data from gps 
        # meaning we have valid gps data, else we obtained all empty values or only time data (first parameter)
